      ...
      <main className="flex min-h-[calc(100vh-64px)] items-center justify-center px-4">
        <div className="w-full max-w-md">
          <div className="text-center">
            ...
            <h1 className="mt-5 font-display text-3xl font-black text-surface-900">Create your account</h1>
            <p className="mt-2 text-sm text-surface-600">Get started with Orion Education — scholarships, counselling and college admissions.</p>
          </div>
