    ...
    <section className="relative overflow-hidden bg-brand-gradient text-white">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-24 lg:px-8 lg:py-28">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-lg text-surface-200/70">
            Compare verified fees, placements and ratings across partner colleges. Pick a shortlist,
            send one enquiry, and a counsellor handles the rest.
          </p>

          <div className="mx-auto mt-8 flex max-w-xl items-center gap-2 rounded-2xl border border-white/20 bg-white/70 p-2 shadow-glass backdrop-blur-xl">
